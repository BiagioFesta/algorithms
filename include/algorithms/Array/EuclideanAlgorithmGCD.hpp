...
*/
#ifndef ALGORITHMS__ARRAY__EUCLIDEAN_ALGORITHM_GCD__HPP
#define ALGORITHMS__ARRAY__EUCLIDEAN_ALGORITHM_GCD__HPP
...
#endif  // ALGORITHMS__ARRAY__EUCLIDEAN_ALGORITHM_GCD__HPP

 ...
 *
 *  \Complexity      Time: O(N^2)      Space: O(N)
 *  \url https://www.geeksforgeeks.org/puzzle-set-35-2-eggs-and-100-floors/
 *
 ...
 *  empty array.
 *
 *  \Complexity     Time: O(N x min(iMaxJump, N))     Space: O(N)
 *  \url https://www.leetfree.com/problems/coin-path.html
 */
